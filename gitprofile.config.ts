...
const CONFIG = {
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['BENfrost-20/hpc-monte-carlo-optimization', 'BENfrost-20/astralog-hpc-telemetry-processing', 'BENfrost-20/credit-default-numerical-ml', 'BENfrost-20/multiplatform-DL-pipeline'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  resume: {
    fileUrl:
      '/leonardo_pelorosso_cv.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
