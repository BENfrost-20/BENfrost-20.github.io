  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['BENfrost-20/montecarlo-DGL', 'BENfrost-20/multiplatform-DL-pipeline'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
